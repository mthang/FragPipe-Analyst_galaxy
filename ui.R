          ...
          menuItem("Analysis", tabName="analysis", icon=icon("flask"),
		     ...
		     div(id="upload_area",
                   ...
                   conditionalPanel(
                     ...
                     fileInput('tmt_expr', 'Upload gene-level or protein-level TMT-I report *.tsv',
                               accept=c('text/tsv',
                                        'text/tab-separated-values,text/plain',
                                        '.tsv')),
      ...
      div(id="quickstart_info",
                    fluidPage(
                      box(
                        ...
                        tags$ul(
                          tags$li("Choose the type of experiment you performed. Currently, DDA-based LFQ (MS1-based or spectral count), TMT, and DIA are supported. Users could also choose to perform analysis at the protein or peptide levels."),
                          tags$li("For DDA LFQ:",
                                  tags$ul(
                                    tags$li("For protein:", "Upload ", tags$b("combined_protein.tsv "), "generated by ",
                                    ...
                                    tags$li("For peptide:", "Upload ", tags$b("combined_peptide.tsv "), "generated by ",
                                                      tags$a(href="https://github.com/Nesvilab/IonQuant", target="_blank", "IonQuant"),
                                                      " in ", tags$a(href="https://fragpipe.nesvilab.org/", target="_blank", "FragPipe")),
                          ...
                          tags$li("For TMT:",
                                  tags$ul(
                                    tags$li("For protein or gene:", "Upload gene-level report", tags$b("[abundance/ratio]_gene_[normalization].tsv"), "or protein-level report",
                                    ...
                                    tags$li("For peptide:", "Upload peptide-level report",
                                            tags$b("[abundance/ratio]_peptide_[normalization].tsv"), "generated by ",
                                            tags$a(href="https://tmt-integrator.nesvilab.org/", target="_blank", "TMT-Integrator (TMT-I)"), "in ",
                                            tags$a(href="https://fragpipe.nesvilab.org/", target="_blank", "FragPipe"),
                                            "(we recommend ", tags$b("abundance_peptide_MD.tsv"), "file). If peptide option is enabled in the server, TMT-I peptide report could also be used alternatively."),
                                    tags$li("Upload", tags$b("experiment_annotation.tsv"), "file. Edit the template file generated by FragPipe;",
                                            " Check ", tags$a(href="https://github.com/MonashProteomics/FragPipe-Analyst/tree/main/docs", target="_blank", "here"),
                                            " for details.")
                                  )
                          ...
                          tags$li("For DIA:",
                                  tags$ul(
                                    tags$li("For protein:", "Upload protein group (PG) matrix (", tags$b("diann-output.pg_matrix.tsv"), ") generated by ",
                                            tags$a(href="https://github.com/vdemichev/DiaNN", target="_blank", "DIA-NN"),
                                            " in ", tags$a(href="https://fragpipe.nesvilab.org/", target="_blank", "FragPipe")),
                                    tags$li("For peptide:", "Upload precursor group matrix (", tags$b("diann-output.pr_matrix.tsv"), ") generated by ",
                                            tags$a(href="https://github.com/vdemichev/DiaNN", target="_blank", "DIA-NN"),
                                            " in ", tags$a(href="https://fragpipe.nesvilab.org/", target="_blank", "FragPipe")),
